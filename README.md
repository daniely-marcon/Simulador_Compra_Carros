...
Este repositório contém um  exercício práticos desenvolvido com foco no desenvolvimento nativo para Android utilizando a linguagem **Java**.
...
* **Destaques Técnicos:**
    ...
    * **Validação de Formulário:** Implementação de lógica preventiva com `.isEmpty()` para garantir a integridade dos dados enviados.
